document.addEventListener('DOMContentLoaded', function () {
  let widgetName = "blueberry"; ///////////////////////// КОМПОНЕНТЫ ПАНЕЛИ /////////////////////////
  // логотип
  ...
  blueberryWidget.className = widgetName; // список модулей, включенных в панель

  blueberryWidget.innerHTML = [logoModule, fontSizeModule, letterSpacingModule, imagesModule, themesModule, resetSettingsModule, offModule].join('');
  document.body.prepend(blueberryWidget); ///////////////////////// ФУНКЦИИ ДЛЯ РАБОТЫ С COOKIE /////////////////////////
  // получение cookie
